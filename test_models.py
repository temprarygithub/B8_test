...
class Dept(models.Model):
    ...
    collage = models.ForeignKey(Collage, models.DO_NOTHING)
...
class Person(models.Model):
    ...
    data_updated = models.DateTimeField(blank=True, null=True)
...
class Principal(models.Model):
    ...
    collage = models.OneToOneField(Collage, models.DO_NOTHING)
